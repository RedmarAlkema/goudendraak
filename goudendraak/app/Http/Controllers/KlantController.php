...
class KlantController extends Controller
{
    ...
    {        
        try {
            ...
            return redirect()->back()->withErrors('Er is iets misgegaan bij het toevoegen aan de winkelwagen.');
        }
    }
    ...
    public function cartItemCount()
    {
        try {
            ...
            \Log::error('Fout in de cartItemCount-functie: ' . $e->getMessage());
            return response()->json(['error' => 'Er is iets misgegaan bij het ophalen van het aantal items.'], 500);
        }
    }
    ...
    public function cartIndex()
    {
        try {
            ...
            \Log::error('Fout in de cartIndex-functie: ' . $e->getMessage());
            return response()->view('errors.general', [], 500);
        }
    }
    ...
    public function updateCart(Request $request)
    {
        try {
            ...
            \Log::error('Fout in de updateCart-functie: ' . $e->getMessage());
            return redirect()->back()->withErrors('Er is iets misgegaan bij het bijwerken van de winkelwagen.');
        }
    }
    ...
    public function storeTableNumber(Request $request)
    {
        try {
            ...
            \Log::error('Fout in de storeTableNumber-functie: ' . $e->getMessage());
            return redirect()->back()->withErrors('Er is iets misgegaan bij het opslaan van het tafelnummer.');
        }
    }
    ...
    public function removeItem(Request $request)
    {
        try {
            ...
            \Log::error('Fout in de removeItem-functie: ' . $e->getMessage());
            return redirect()->back()->withErrors('Er is iets misgegaan bij het verwijderen van het item uit de winkelwagen.');
        }
    }
    ...
    public function checkout()
    {
        try {
            ...
            \Log::error('Fout in de checkout-functie: ' . $e->getMessage());
            return redirect()->back()->withErrors('Er is iets misgegaan bij het afrekenen.');
        }
    }
    ...
    public function thankYou()
    {
        try {
            ...
            \Log::error('Fout in de thankYou-functie: ' . $e->getMessage());
            return redirect()->route('cart.index')->withErrors('Er is iets misgegaan bij het tonen van het bedankbericht.');
        }
    }
}
